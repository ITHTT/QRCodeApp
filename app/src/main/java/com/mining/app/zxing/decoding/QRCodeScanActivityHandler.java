...
import com.htt.qrcodeapp.activitys.QRCodeScanActivity;
...
public final class QRCodeScanActivityHandler extends Handler {
  ...
  private static final String TAG = QRCodeScanActivityHandler.class.getSimpleName();
  ...
  public QRCodeScanActivityHandler(QRCodeScanActivity activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
